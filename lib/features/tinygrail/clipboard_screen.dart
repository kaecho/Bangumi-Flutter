...
class TinygrailClipboardScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<TinygrailClipboardScreen> createState() => _TinygrailClipboardScreenState();
}

class _TinygrailClipboardScreenState extends ConsumerState<TinygrailClipboardScreen> {
  List<int> _ids = const [];
  bool _loading = false;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(icon: const Icon(Icons.paste), onPressed: _paste),
        ],
      ),
      body: _ids.isEmpty
          ? Center(
...
final clipboardProvider = FutureProvider.family<List<TinygrailChara>, List<int>>((ref, ids) async {
