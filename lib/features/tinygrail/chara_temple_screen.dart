            ...
            : ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  return UserTile(
                    ...
                    avatar: item.avatar,
                    subtitle:
                        'Lv.${item.level} · 献祭 ${tgAmount(item.sacrifices)} · 资产 ${tgMoney(item.assets)}',
...
final _templeProvider = FutureProvider.family<List<TinygrailTemple>, int>((
  ref,
  monoId,
) async {
...
final _valhallaProvider =
    FutureProvider.family<({int amount, List<TinygrailLog> logs}), int>((
      ref,
      monoId,
    ) async {
